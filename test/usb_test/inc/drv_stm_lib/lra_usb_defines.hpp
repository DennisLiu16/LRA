...
//  *        low byte is cmd_type byte (defined in LRA_USB_IN_Cmd_t). If the
//  parser
...
//  * 3. retval == PR_PRECHECK_FAIL | no 0, precheck failed with specific
//  command
//  * type
...
//  *
//  * @warning update LRA_USB_Parse_Precheck() and LRA_USB_Main_Parser() once
//  you
